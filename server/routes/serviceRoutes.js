...
router.get('/update/:serviceId', serviceController.getupdatepage)
router.get('/delete/:serviceId', serviceController.deleteById)

router.post('/update/:serviceId', upload.single("image"),async (req,res)=>{
